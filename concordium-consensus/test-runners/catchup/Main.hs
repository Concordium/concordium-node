...
main = do
    ...
    let (gen, bis) = makeGenesisData now n 1 0.5 1 dummyFinalizationStakeFraction dummyFinalizationCommitteeMaxSize dummyCryptographicParameters dummyIdentityProviders []
