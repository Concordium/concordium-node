...
Copy `%LOCALAPPDATA%\Programs\stack\x86_64-windows\ghc-9.8.4\mingw\bin\libwinpthread-1.dll` to `%LOCALAPPDATA%\Programs\stack\x86_64-windows\ghc-9.8.4\mingw\bin\pthread.dll`.
