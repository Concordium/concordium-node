...
;; Then triggers two upgrades of the module, checks whether it is successful and calls the name function in between upgraing checking that the identifier have changed as expected.
(module
