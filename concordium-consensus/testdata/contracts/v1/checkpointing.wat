...
(module
  ...
  (func $a_modify_proxy (export "a.a_modify_proxy") (param $amount i64) (result i32)
    ...
    ;; We carry out a transfer if this contract is invoked with an amount of '1234'.
    ...
    ;; If this contract was invoked with '10000000' then it is expected that the contract invocation is:
    ;; 1. Invoking a v1 contract and
    ;; 2. A subsequent invocation will trap.
    ;; If this contract was invoked with '10000001' then it is expected that the contract invocation is:
    ...
    (if (i64.eq (i64.const 10000000) (local.get $amount))
      ...
      (else (if (i64.eq (i64.const 10000001) (local.get $amount))
