...
;; The module provided should be deployed but not contain any contract name 'contract'.
;; It ensures the upgrade fails because of missing contract and then returns success.
(module
 ;; Imports
 ...
 (func $contract_upgrade (export "contract.upgrade")  (param i64) (result i32)
       ...
       ;; Trigger the upgrade.
       (call $assert_eq_64
             (i64.const 34359738368) ;; expect the error code for missing contract 0x0000_0008_0000_0000.
