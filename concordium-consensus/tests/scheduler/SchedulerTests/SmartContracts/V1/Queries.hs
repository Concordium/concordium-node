...
initialBlockStateWithStakeAndSchedule =
  ...
  where
    extra =
        (mkAccount @'AccountV2 thomasVK thomasAccount thomasBalance)
...
accountBalanceTestCase =
    TestCase
        { tcName = "Simple account balance query",
...
accountBalanceInvokerTestCase =
    TestCase
        { tcName = "Query the account balance of the invoker",
...
accountBalanceTransferTestCase =
    TestCase
        { tcName = "Contracts transfers to an account and then queries",
          tcParameters = (defaultParams @PV5){tpInitialBlockState = initialBlockState},
          tcTransactions =
            [   ( TJSON
...
accountBalanceMissingAccountTestCase =
    TestCase
        { tcName = "Query the balance of a missing account",
          tcParameters = (defaultParams @PV5){tpInitialBlockState = initialBlockState},
          tcTransactions =
            [   ( TJSON
...
contractBalanceTestCase =
    TestCase
        { tcName = "Query the balance a contract",
          tcParameters = (defaultParams @PV5){tpInitialBlockState = initialBlockState},
          tcTransactions =
            [   ( TJSON
...
contractBalanceSelfTestCase =
    TestCase
        { tcName = "Query the balance of the contract itself",
          tcParameters = (defaultParams @PV5){tpInitialBlockState = initialBlockState},
          tcTransactions =
            [   ( TJSON
                    { payload = DeployModule V1 contractBalanceSourceFile,
...
contractBalanceMissingContractTestCase =
    TestCase
        { tcName = "Query the balance of a missing contract",
          tcParameters = (defaultParams @PV5){tpInitialBlockState = initialBlockState},
          tcTransactions =
            [   ( TJSON
...
exchangeRatesTestCase =
    TestCase
        { tcName = "Query the exchange rates",
          tcParameters = (defaultParams @PV5){tpInitialBlockState = initialBlockState},
          tcTransactions =
            [   ( TJSON
...
allTestCase =
    TestCase
        { tcName = "Ensure all of the queries fail prior to PV5",
