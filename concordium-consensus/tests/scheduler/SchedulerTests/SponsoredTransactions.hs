...
deriving via (MGSTrans (TestAccountNonceQueryT bs) m) instance (ForeingLowLevelBlockStateQuery m) => ForeingLowLevelBlockStateQuery (TestAccountNonceQueryT bs m)
