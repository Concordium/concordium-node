...
initialiseStates n = do
        ...
        let bps = BirkParameters 0.5 (fst . bakersFromList $ (^. _2 . _1) <$> bis) ((fst . bakersFromList $ (^. _2 . _1) <$> bis), (fst . bakersFromList $ (^. _2 . _1) <$> bis)) (genesisSeedState (hash "LeadershipElectionNonce") 360)
