...
createInitStates bis maxFinComSize extraAccounts = do
        let genesisBakers = fst . bakersFromList $ (^. _2 . _1) <$> bis
            ...
            gen = GenesisDataV1 0 1 genesisBakers seedState (bakerAccounts ++ specialAccounts) (finalizationParameters maxFinComSize) dummyCryptographicParameters emptyIdentityProviders dummyArs 10 (Energy maxBound) dummyAuthorizations dummyChainParameters
