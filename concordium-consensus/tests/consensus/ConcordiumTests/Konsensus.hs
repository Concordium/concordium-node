...
initialiseStates n = do
        ...
        let bps = BirkParameters 0.5 (bakersFromList $ (^. _2 . _1) <$> bis) ((bakersFromList $ (^. _2 . _1) <$> bis), (bakersFromList $ (^. _2 . _1) <$> bis)) (genesisSeedState (hash "LeadershipElectionNonce") 360)
