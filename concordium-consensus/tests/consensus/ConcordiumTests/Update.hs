...
createInitStates = do
    ...
    let bis = baker1 : [baker2] 
        ...
        gen = GenesisDataV1 0 1 genesisBakers seedState bakerAccounts finalizationParameters dummyCryptographicParameters emptyIdentityProviders dummyArs 10 (Energy maxBound) Dummy.dummyAuthorizations cps
