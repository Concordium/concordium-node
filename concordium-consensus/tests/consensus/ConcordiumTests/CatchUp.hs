        ...
        case response of
            ...
            Just (l, rstatus) -> do
                ...
                unless (lfh2 < lfh1) $ do
                    ...
                    let recBHs = [getHash bp | (MessageBlock, runGet (B.getBlockV0 0) -> Right bp) <- l]
                    ...
                    let
                        ...
                        testList knownBlocks knownFin ((MessageBlock, runGet (B.getBlockV0 0) -> Right (B.NormalBlock bp)) : rs) = do
