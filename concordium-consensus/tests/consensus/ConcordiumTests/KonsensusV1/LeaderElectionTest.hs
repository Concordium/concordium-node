...
testUpdateSeedStateForEpoch =
    it "updateSeedStateForEpoch" $
        updateSeedStateForEpoch bkrs 1000 ss `shouldBe` ss'
  where
    ss =
        SeedStateV1
            { epoch = 27,
    ...
    ss' =
        SeedStateV1
            { epoch = 28,
              ...
              updatedNonce = read "7fe22f09ff285479950351e383068cfeab86683753eebeade1f634c45b0558e3",
              currentLeadershipElectionNonce = read "7fe22f09ff285479950351e383068cfeab86683753eebeade1f634c45b0558e3"
            }
    bkrs =
        FullBakers
            { fullBakerInfos = Vec.fromList [FullBakerInfo (BakerInfo 1 bek bsk bak) 1000000000000],
              bakerTotalStake = 1000000000000
            }
