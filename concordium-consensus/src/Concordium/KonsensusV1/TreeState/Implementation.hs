...
instance (Monad m, MonadReader r m, IsConsensusV1 pv, HasSkovState r pv, r ~ SkovData pv) => MonadTreeState (TreeStateWrapper pv m) where
    ...
    getQuorumSignatureMessages = undefined
    setQuorumSignatureMessages = undefined
    getTimeoutMessages = undefined
    setTimeoutMessage = undefined
    getRoundStatus = undefined
    setRoundStatus = undefined
    addTransaction = undefined
    commitTransactions = undefined
