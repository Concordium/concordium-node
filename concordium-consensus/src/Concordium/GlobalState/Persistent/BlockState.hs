...
doGetAccountByCredId :: (IsProtocolVersion pv, MonadBlobStore m) => PersistentBlockState pv -> ID.CredentialRegistrationIDRaw -> m (Maybe (AccountIndex, PersistentAccount (AccountVersionFor pv)))
