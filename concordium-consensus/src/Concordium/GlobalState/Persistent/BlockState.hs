...
doGetAccountByCredId :: (SupportsPersistentAccount av pv m) => PersistentBlockState pv -> ID.CredentialRegistrationID -> m (Maybe (AccountIndex, PersistentAccount (AccountVersionFor pv)))
