...
-- Returns @Nothing@ if no such account exists.
getAccountByCredId :: SupportsPersistentAccount av pv m => ID.CredentialRegistrationID -> Accounts pv -> m (Maybe (AccountIndex, PersistentAccount (AccountVersionFor pv)))
