...
data BakerPoolRewardDetails = BakerPoolRewardDetails
    { -- | The number of blocks baked by this baker in the reward period
      ...
      missedRounds :: !Word16,
      -- | Accumulated activty (baked blocks/signed finalization proofs) since the last payday
      wasActive :: !Bool
    }
    deriving (Eq, Show)
...
instance Serialize BakerPoolRewardDetails where
    ...
    get = BakerPoolRewardDetails <$> getWord64be <*> get <*> getBool <*> getWord16be <*> getBool
