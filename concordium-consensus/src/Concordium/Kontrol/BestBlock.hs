...
blockLuck :: (SkovQueryMonad pv m, BlockPointerMonad m) => BlockPointerType m -> m BlockLuck
...
compareBlocks :: (SkovQueryMonad pv m, BlockPointerMonad m)
              => BlockPointerType m
...
bestBlockBranches :: forall pv m. (SkovQueryMonad pv m, BlockPointerMonad m) => [[BlockPointerType m]] -> m (BlockPointerType m)
...
bestBlock :: forall pv m. (SkovQueryMonad pv m, BlockPointerMonad m) => m (BlockPointerType m)
...
bestBlockBefore :: forall pv m. (SkovQueryMonad pv m, BlockPointerMonad m) => Slot -> m (BlockPointerType m)
...
bestBlockOf :: (SkovQueryMonad pv m, BlockPointerMonad m) => Branches m -> m (Maybe (BlockPointerType m))
