...
import Concordium.GlobalState.BlockState (AccountOperations, BlockStateOperations, BlockStateQuery, BlockStateStorage, ContractStateOperations, ForeignLowLevelBlockStateOperations, ForeignLowLevelBlockStateQuery, ModuleQuery, PLTQuery, TokenStateOperations)
