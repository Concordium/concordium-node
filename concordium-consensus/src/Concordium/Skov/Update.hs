...
mapTransactionVerificationResult (TV.NormalTransactionInvalidSender _) = ResultNonexistingSenderAccount
mapTransactionVerificationResult (TV.NormalTransactionInvalidNonce _) = ResultDuplicateNonce
mapTransactionVerificationResult TV.NormalTransactionInvalidSignatures = ResultVerificationFailed
