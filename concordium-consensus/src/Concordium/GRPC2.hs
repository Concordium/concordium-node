...
instance ToProto (Parameters.MintDistribution 'ChainParametersV0) where
  type Output (Parameters.MintDistribution 'ChainParametersV0) = Proto.UpdatePayload'MintDistributionUpdatePayload
...
instance ToProto (TransactionTime, QueryTypes.PendingUpdateEffect) where
    ...
    toProto (time, effect) = Proto.make $ do
      ...
      case effect of
        ...
        QueryTypes.PUEMicroGTUPerEuro microCcdPerEuro -> ProtoFields.microCcdPerEuro .= toProto microCcdPerEuro
