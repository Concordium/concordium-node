...
-- TODO: This is not an ideal configuration.
...
import qualified Proto.Concordium.Types as ProtoFields
...
convertUpdatePayload ut pl = case (ut, pl) of
  (Updates.UpdateProtocol, Updates.ProtocolUpdatePayload Updates.ProtocolUpdate {..}) ->
    Right . Proto.make $
      ProtoFields.protocolUpdate
        .= Proto.make
          ( do
  ...
  (Updates.UpdateMintDistribution, Updates.MintDistributionUpdatePayload md) ->
    Right . Proto.make $
      ProtoFields.mintDistributionUpdate
        .= Proto.make
          ( do
  ...
  (Updates.UpdateTransactionFeeDistribution, Updates.TransactionFeeDistributionUpdatePayload Parameters.TransactionFeeDistribution {..}) ->
    Right . Proto.make $
      ProtoFields.transactionFeeDistributionUpdate
        .= Proto.make
          ( do
              ProtoFields.baker .= toProto _tfdBaker
              ProtoFields.gasAccount .= toProto _tfdGASAccount
          )
  (Updates.UpdateGASRewards, Updates.GASRewardsUpdatePayload Parameters.GASRewards {..}) ->
    Right . Proto.make $
      ProtoFields.gasRewardsUpdate
        .= Proto.make
          ( do
  ...
  (Updates.UpdateCooldownParameters, Updates.CooldownParametersCPV1UpdatePayload cp) -> Right $ case cp of
    Parameters.CooldownParametersV1 {..} ->
      Proto.make $
        ProtoFields.cooldownParametersCpv1Update
          .= Proto.make
            ( do
                ProtoFields.poolOwnerCooldown .= toProto _cpPoolOwnerCooldown
                ProtoFields.delegatorCooldown .= toProto _cpDelegatorCooldown
            )
  (Updates.UpdatePoolParameters, Updates.PoolParametersCPV1UpdatePayload pp) ->
    Right . Proto.make $
      ProtoFields.poolParametersCpv1Update
        .= Proto.make
          ( do
  ...
  (Updates.UpdateTimeParameters, Updates.TimeParametersCPV1UpdatePayload tp) -> Right $ case tp of
    Parameters.TimeParametersV1 {..} ->
      Proto.make $
        ProtoFields.timeParametersCpv1Update
          .= Proto.make
            ( do
                ProtoFields.rewardPeriodLength .= toProto _tpRewardPeriodLength
                ProtoFields.mintPerPayday .= toProto _tpMintPerPayday
            )
  (Updates.UpdateMintDistribution, Updates.MintDistributionCPV1UpdatePayload md) ->
    Right . Proto.make $
      ProtoFields.mintDistributionCpv1Update
        .= Proto.make
          ( do
              ProtoFields.bakingReward .= toProto (Parameters._mdBakingReward md)
              ProtoFields.finalizationReward .= toProto (Parameters._mdFinalizationReward md)
...
instance ToProto QueryTypes.PoolStatus where
  ...
  toProto QueryTypes.BakerPoolStatus {..} = Left $
    Proto.make $ do
  ...
  toProto QueryTypes.PassiveDelegationStatus {..} = Right $
    Proto.make $ do
      ProtoFields.delegatedCapital .= toProto psDelegatedCapital
