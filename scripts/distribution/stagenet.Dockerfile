...
ENV CONCORDIUM_NODE_CONNECTION_BOOSTRAP_NODES=bootstrap.eu.staging.concordium.com:8888
ENV CONCORDIUM_NODE_CONNECTION_NO_DNSSEC=1

# Concordium Node Collector configuration
ENV CONCORDIUM_NODE_COLLECTOR_URL=https://dashboard.eu.staging.concordium.com/nodes/post
