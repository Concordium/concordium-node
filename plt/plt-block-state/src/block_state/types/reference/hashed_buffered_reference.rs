use crate::block_state::types::reference::{Link, BlobReference};
use concordium_base::hashes::Hash;
use crate::block_state::blob_store::{BackingStoreLoad, BackingStoreStore, DecodeError, Loadable, Storable};
