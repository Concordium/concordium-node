...
mod test {
    ...
    fn test_lock_return_not_authorized_reject_reason_serial() {
        ...
        assert_eq!(
            hex::encode(&bytes),
            "3d0000000000fedcba0000000000001234000000000000005000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f"
        );
    }
    ...
    fn test_lock_cancel_not_authorized_reject_reason_serial() {
        ...
        assert_eq!(
            hex::encode(&bytes),
            "3e0000000000fedcba0000000000001234000000000000005000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f"
        );
    }
    ...
    fn test_lock_recipient_impermissible_reject_reason_serial() {
        ...
        assert_eq!(
            hex::encode(&bytes),
            "400000000000fedcba0000000000001234000000000000005000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f"
        );
    }
}
