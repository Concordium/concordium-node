...
///
/// Allows defining functions which works for both [`TokenQueryExecution`] and
/// [`TokenOperationExecution`].
...
///
/// Takes a concrete [`TokenContextQueriesImpl`] because account index lookups are needed
