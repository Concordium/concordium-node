//! Internal constants and utitlies for token module state.
...
pub const MODULE_STATE_PREFIX: [u8; 2] = 0u16.to_le_bytes();
...
pub fn module_state_key<'a>(key: impl IntoIterator<Item = &'a u8>) -> ModuleStateKey {
