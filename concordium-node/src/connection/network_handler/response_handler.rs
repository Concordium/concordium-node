...
impl ResponseHandler {
    pub fn new() -> Self {
        ResponseHandler {
            pong_handler:      AFunctor::<NetworkResponse>::new("Network::Response::Pong"),
            find_node_handler: AFunctor::<NetworkResponse>::new("Network::Response::FindNode"),
            peer_list_handler: AFunctor::<NetworkResponse>::new("Network::Response::PeerList"),
            handshake_handler: AFunctor::<NetworkResponse>::new("Network::Response::Handshake"),
        }
    }
