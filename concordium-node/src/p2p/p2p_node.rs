...
impl P2PNode {
    ...
    pub fn ban_node(&mut self, peer: BannedNode) { self.noise_protocol_handler.ban_node(peer); }

    pub fn unban_node(&mut self, peer: BannedNode) { self.noise_protocol_handler.unban_node(peer); }
