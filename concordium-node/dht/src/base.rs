...
/// Further generalization of num::BigUint, including hexadecimal encoding and decoding
pub trait GenericIdentifier : Hash + PartialEq + Eq + Ord + Clone + Send + Sync + Debug {
...
impl GenericIdentifier for u64 {
...
impl GenericIdentifier for Vec<u8> {
