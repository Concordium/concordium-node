...
mod tests {
    ...
    pub fn test_grpc_version() {
        ...
        let node = P2PNode::new(None, 8888, pkt_in, Some(sender),P2PNodeMode::NormalMode, None);
    ...
    pub fn test_grpc_noauth() {
        ...
        let node = P2PNode::new(None, 8889, pkt_in, Some(sender),P2PNodeMode::NormalMode, None);
