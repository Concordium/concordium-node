...
FROM 192549843005.dkr.ecr.eu-west-1.amazonaws.com/concordium/base:0.13 as build
ARG consensus_type
...
FROM 192549843005.dkr.ecr.eu-west-1.amazonaws.com/concordium/base:0.13 as haskell-build
...
FROM 192549843005.dkr.ecr.eu-west-1.amazonaws.com/concordium/base-haskell:0.12 as midlang-build
WORKDIR /
