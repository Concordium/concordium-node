...
FROM 192549843005.dkr.ecr.eu-west-1.amazonaws.com/concordium/base:0.8 as build
ARG consensus_type
...
FROM 192549843005.dkr.ecr.eu-west-1.amazonaws.com/concordium/base:0.8 as haskell-build
...
# Build oak compiler
FROM 192549843005.dkr.ecr.eu-west-1.amazonaws.com/concordium/base-haskell:0.6 as oak-build
WORKDIR /
...
RUN git checkout 4a6e05f83cd9b4d54f1cdfc65dcd1550a7e3e6db
