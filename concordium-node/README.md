...
* static - builds against static haskell libraries in GIT LFS (Linux only)
* profiling - builds against haskell libraries in GIT LFS with profiling support enabled (Linux only)
