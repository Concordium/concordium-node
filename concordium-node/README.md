...
* [Rust](https://www.rust-lang.org/tools/install)
  * For building the node, the toolchain `1.53.0-x86_64-pc-windows-gnu` is required, which can be install with the command: `rustup toolchain install 1.53.0-x86_64-pc-windows-gnu`.
  * For building the node runner service (optional), the toolchain `1.53.0-x86_64-pc-windows-msvc`  is required, which can be install with the command: `rustup toolchain install 1.53.0-x86_64-pc-windows-msvc`.
